var Contents = new (function(){
    ...
    this.slideCont = function(el){
        ...
        if( div.is(':hidden') ){
            div.slideDown('slow', function(){
                $(el).parent().parent().find('img.jq-icon').attr('src', 'public/images/icon_arrow_up.png');
            ...
            div.slideUp('slow', function(){
                $(el).parent().parent().find('img.jq-icon').attr('src', 'public/images/icon_arrow_down.png');
            });
    ...
    this.save = function(el, reference, id){
        ...
        _working=true;
        el.disabled = true;
        $.post(get_url('panel/contents/ajax_save'), params, function(data){
            al.hide();
            _working=false;
            el.disabled = false;
