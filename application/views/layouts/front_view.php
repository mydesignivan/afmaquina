...
<body>
    <div class="container">
        ...
        <div class="clear span-24 last main-container">
            <div class="contents" <?php if($this->uri->segment(1)=="panel" || $this->uri->segment(1)=='videos') echo 'style="width:100%"'?>>
                <?php echo $this->template->yield(); ?>
            </div>
            <?php if( $this->uri->segment(1)!="panel" && $this->uri->segment(1)!='videos' ){?>
            <div class="sidebar">
