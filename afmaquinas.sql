...
--
-- Servidor: localhost
-- Tiempo de generación: 16-12-2010 a las 17:59:38
...
CREATE TABLE IF NOT EXISTS `categories` (
  ...
  `codlang` tinyint(2) NOT NULL,
  `parent_id` int(11) NOT NULL DEFAULT '0',
  `categorie_name` varchar(200) NOT NULL,
  `categorie_content` longtext NOT NULL,
...
INSERT INTO `categories` (`categories_id`, `codlang`, `parent_id`, `categorie_name`, `categorie_content`, `order`, `reference`, `level`, `date_added`, `last_modified`) VALUES
(4, 1, 0, 'categoria1', '', 1, 'categoria1', 0, '1292382000', '1292382000');
...
('3f632f1201292d2f2da4f2a34e0b707f', '127.0.0.1', 'Mozilla/5.0 (X11; U; Linux x86_64; es-AR; rv:1.9.2', 1292505906, ''),
('55d0c6743625f34df11eee721caa4293', '127.0.0.2', 'Mozilla/5.0 (X11; U; Linux x86_64; es-AR; rv:1.9.2', 1292515801, ''),
('c1f1426f95ebf28fb04b562ae1347d50', '127.0.0.1', 'Mozilla/5.0 (X11; U; Linux x86_64; es-AR; rv:1.9.2', 1292507509, ''),
('44f1e60e1bfd7100ec1b71b1c8dd02da', '127.0.0.1', 'Mozilla/5.0 (X11; U; Linux x86_64; es-AR; rv:1.9.2', 1292503113, '');
...
(15, 'nosotros', 'Nosotros', '<h1 class="title">Nosotros</h1>\n<p>AF M&aacute;quinas y Herramientas SRL, nace en la provincia de Mendoza, Argentina; con el prop&oacute;sito de proveer m&aacute;quinas y herramientas a todo sector industrial (metal mec&aacute;nico, rectificado de motores, industria minera, qu&iacute;mica, etc.).</p>\n<p>Con el objeto de ampliar su mercado y preocupada por reducir las distancias entre cliente y producto, se ha convertido en importadora/exportadora de m&aacute;quinas de herramienta convencionales y de alta tecnolog&iacute;a, ofreciendo productos de &oacute;ptima calidad a precios competitivos.</p>\n<p>Su pol&iacute;tica empresarial se centra en mejorar cada vez m&aacute;s sus servicios y es por ello que brinda un eficiente asesoramiento profesional durante y despu&eacute;s de su compra.</p>\n<p>AF M&aacute;quinas y Herramientas SRL, al servicio de la industria, trabaja d&iacute;a a d&iacute;a para ofrecer una excelente atenci&oacute;n, para as&iacute; poder lograr una estrecha relaci&oacute;n con sus clientes basada en la confianza y el respeto.</p>', '1286420400', '1292382000'),
(16, 'contacto', 'Contacto', 'Si quiere contactarnos para mayor informaci&oacute;n de nuestros productos o para ideas y sugerencias, puede hacerlo llenando el formulario o a las siguientes direcciones:\r\n<br /><br />\r\n<b>AF Maquinas y Herramientas S.R.L.\r\n</b><br />\r\nEj&acute;rcito de los Andes 460. Dorrego, Mendoza M5526GVH. Argentina\r\n<br />\r\n<b>Teléfono:</b>  ++54 (261) 4320692/4316949\r\n<br />\r\n<b>Email:</b>  info@afmaquinas.com.ar\r\n', '1286420400', '1286420400');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `gallery_products`
--
...
--
-- Volcar la base de datos para la tabla `gallery_products`
--
...
CREATE TABLE IF NOT EXISTS `products` (
  ...
  `categorie_reference` varchar(255) NOT NULL,
  `codlang` tinyint(2) NOT NULL,
...
INSERT INTO `users` (`users_id`, `username`, `password`, `email_contact`, `date_added`, `last_modified`) VALUES
(2, 'admin', '4MEt6GePFtXIXW1EHlEJ3Tecv47sl5v9DqXIJg==', 'ivan@mydesign.com.ar', '2010-08-23 19:07:45', '2010-09-04 12:35:17'),
(3, 'mydesign', 'A2YFbw1zWyZRcwlhBzQFaQIEDB0=', 'ivan@mydesign.com.ar', '2010-08-23 19:09:30', '2010-12-15 16:40:18');
